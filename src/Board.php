...
class Board
{
    ...
    protected function checkMovesOrder($figure)
    {
        if (null !== $this->prevMoveOwner && $figure->isBlack == $this->prevMoveOwner) {
            throw new \Exception("Incorrect move sequence");
        }

        $this->prevMoveOwner = $figure->isBlack;
    }
    ...
    public function move($move)
    {
        ...
        if (isset($this->figures[$xFrom][$yFrom])) {
            $this->checkMovesOrder($this->figures[$xFrom][$yFrom]);
            $this->figures[$xFrom][$yFrom]->checkMoveDirection([$xFrom, $yFrom], [$xTo, $yTo], $this->figures);
